      ...
      <div className="container max-w-6xl px-4 relative z-10">
        <div className="text-center mb-16">
          ...
          <h1 className="text-5xl md:text-7xl font-black font-headline tracking-tighter leading-tight drop-shadow-[0_0_25px_rgba(255,255,255,0.3)]">
            AI <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-pink-400 to-blue-400 animate-gradient-x">Trip Architect</span>
          </h1>
        ...
        <div className="bg-card/40 backdrop-blur-xl p-8 md:p-12 rounded-[2.5rem] shadow-[0_0_50px_rgba(139,92,246,0.15)] border border-white/10 relative overflow-hidden group">
