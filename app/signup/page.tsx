  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: `Welcome to Destiny Tours, ${name}!`,
      });
        ...
        <Card className="relative border-white/10 bg-slate-900/80 backdrop-blur-xl rounded-3xl shadow-2xl text-white">
          <CardHeader className="text-center space-y-3 pt-8 pb-4">
            ...
            <CardDescription className="text-slate-400 text-sm">
              Sign up to save customized travel itineraries and view booking history.
            </CardDescription>
          </CardHeader>
          ...
          <CardContent className="space-y-6 px-6 sm:px-8">
            <form onSubmit={handleSignup} className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="name" className="text-slate-300 font-semibold text-xs uppercase tracking-wider">Full Name</Label>
            ...
            <div className="relative flex py-2 items-center">
              ...
              <span className="flex-shrink mx-4 text-slate-500 text-xs font-bold uppercase tracking-wider">Or register with</span>
              <div className="flex-grow border-t border-white/10"></div>
            </div>
